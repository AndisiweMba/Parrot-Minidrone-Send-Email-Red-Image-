    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.zeroConstant_Value
                    section.data(1).logicalSrcIdx = 3;
                    section.data(1).dtTransOffset = 0;

                    ;% dexojrsdjj.SendConstant_Value
            ...
            section.data(39)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.fxgka2mnesn.Z_Value
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.jditpbqnwu
                    section.data(3).logicalSrcIdx = 4;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.ocsg3tvuqo
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.mbxzjdly4w
                    section.data(2).logicalSrcIdx = 7;
                    section.data(2).dtTransOffset = 1;

                    ;% ntrh2fpvwnc.fxgka2mnesn.goasb1mges
                    section.data(3).logicalSrcIdx = 8;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.fxgka2mnesn.e0eqiwikmt
                    section.data(4).logicalSrcIdx = 9;
                    section.data(4).dtTransOffset = 3;

                    ;% ntrh2fpvwnc.fxgka2mnesn.luu0ypkcbr
                    section.data(5).logicalSrcIdx = 14;
                    section.data(5).dtTransOffset = 4;

                    ;% ntrh2fpvwnc.fxgka2mnesn.l1yn0bq4ii
                    section.data(6).logicalSrcIdx = 15;
                    section.data(6).dtTransOffset = 5;

                    ;% ntrh2fpvwnc.fxgka2mnesn.kkqaduqc4c
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.il0vetnhvk.LoggedData
                    section.data(1).logicalSrcIdx = 2;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fd1b421ayd.LoggedData
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.eq1zkcrcdk
                    section.data(1).logicalSrcIdx = 4;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.dfuepufaix
                    section.data(2).logicalSrcIdx = 5;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.la3ocmi3sq
            ...
            section.data(15)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.ahrn2cuuz3
                    section.data(5).logicalSrcIdx = 13;
                    section.data(5).dtTransOffset = 4;

                    ;% cjyyyt0pe2y.cfwlkry3xd
                    section.data(6).logicalSrcIdx = 14;
                    section.data(6).dtTransOffset = 5;

                    ;% cjyyyt0pe2y.b0m0xgypvi
                    section.data(7).logicalSrcIdx = 15;
                    section.data(7).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.kjaw4mu0fd
                    section.data(8).logicalSrcIdx = 16;
                    section.data(8).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.oespgxneyr
                    section.data(9).logicalSrcIdx = 17;
                    section.data(9).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.ptbbroassk
                    section.data(10).logicalSrcIdx = 18;
                    section.data(10).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.lmaubmutyw
                    section.data(11).logicalSrcIdx = 19;
                    section.data(11).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.bqu1npprng
                    section.data(12).logicalSrcIdx = 20;
                    section.data(12).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.ayuyzswr2d
                    section.data(13).logicalSrcIdx = 21;
                    section.data(13).dtTransOffset = 12;

                    ;% cjyyyt0pe2y.mq1ivvymmj
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.acqwkwmm2n
                    section.data(5).logicalSrcIdx = 29;
                    section.data(5).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.judiwv25je
                    section.data(6).logicalSrcIdx = 30;
                    section.data(6).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.bztbzo40e2
                    section.data(7).logicalSrcIdx = 31;
                    section.data(7).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.n0ee1qsy1p
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.c5pn12f5tv
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.amnwakv5ej
                    section.data(1).logicalSrcIdx = 71;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.cisghmkons
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.cq5qzeyiqg
                    section.data(2).logicalSrcIdx = 74;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.fxgka2mnesn.miznp3l5zq
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.dptwihkmyh
            ...
            section.data(12)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.fn43yllc3v
    ...
    targMap.checksum0 = 4123261289;
    targMap.checksum1 = 1150120017;
    targMap.checksum2 = 266038476;
    targMap.checksum3 = 2401758003;
