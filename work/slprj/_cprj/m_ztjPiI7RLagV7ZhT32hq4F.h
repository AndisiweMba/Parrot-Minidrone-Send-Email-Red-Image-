#ifndef __ztjPiI7RLagV7ZhT32hq4F_h__
#define __ztjPiI7RLagV7ZhT32hq4F_h__
...
#ifndef struct_tag_TMdMGv1t7i6dUrDaNNMGfE
#define struct_tag_TMdMGv1t7i6dUrDaNNMGfE

struct tag_TMdMGv1t7i6dUrDaNNMGfE
{
  int32_T isInitialized;
  boolean_T TunablePropsChanged;
};

#endif                                 /* struct_tag_TMdMGv1t7i6dUrDaNNMGfE */

#ifndef typedef_parrot_TCPSend
#define typedef_parrot_TCPSend

typedef struct tag_TMdMGv1t7i6dUrDaNNMGfE parrot_TCPSend;

#endif                                 /* typedef_parrot_TCPSend */
...
typedef struct tag_uwJsGEKtvfiUxcdf0z0AYH b_cell_wrap;
...
typedef struct tag_hfuMxtM3511pO8GfZjii3B c_cell_wrap;
...
#ifndef struct_tag_arNsAu0k4EKn3oJmOQ4PR
#define struct_tag_arNsAu0k4EKn3oJmOQ4PR

struct tag_arNsAu0k4EKn3oJmOQ4PR
{
  char_T f1[5];
};

#endif                                 /* struct_tag_arNsAu0k4EKn3oJmOQ4PR */

#ifndef typedef_e_cell_wrap
#define typedef_e_cell_wrap

typedef struct tag_arNsAu0k4EKn3oJmOQ4PR e_cell_wrap;
...
typedef struct tag_6jR4RtbHdjyG00WYqgD5nF f_cell_wrap;
...
#ifndef struct_tag_GZjSpaey3IDRqvh7nZoQMD
#define struct_tag_GZjSpaey3IDRqvh7nZoQMD

struct tag_GZjSpaey3IDRqvh7nZoQMD
{
  e_cell_wrap _data;
};

#endif                                 /* struct_tag_GZjSpaey3IDRqvh7nZoQMD */

#ifndef typedef_s_GZjSpaey3IDRqvh7nZoQMD
#define typedef_s_GZjSpaey3IDRqvh7nZoQMD

typedef struct tag_GZjSpaey3IDRqvh7nZoQMD s_GZjSpaey3IDRqvh7nZoQMD;

#endif                                 /* typedef_s_GZjSpaey3IDRqvh7nZoQMD */
...
#ifndef typedef_InstanceStruct_ztjPiI7RLagV7ZhT32hq4F
#define typedef_InstanceStruct_ztjPiI7RLagV7ZhT32hq4F

typedef struct {
  SimStruct *S;
  parrot_TCPSend sysobj;
  boolean_T sysobj_not_empty;
  void *emlrtRootTLSGlobal;
  uint8_T (*u0)[5];
} InstanceStruct_ztjPiI7RLagV7ZhT32hq4F;

#endif                                 /* typedef_InstanceStruct_ztjPiI7RLagV7ZhT32hq4F */
...
extern void method_dispatcher_ztjPiI7RLagV7ZhT32hq4F(SimStruct *S, int_T method,
  void* data);
